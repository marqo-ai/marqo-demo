            ...
            <div className="flex items-center justify-center w-full">
                <label htmlFor="img-file" className="flex flex-col items-center justify-center w-[fit-content] cursor-pointer">
                    <div className="flex flex-col items-center justify-center">
                        <p className={`${theme === "dark" ? "text-white hover:text-secondary border-slate-200 hover:border-secondary" : "text-primary hover:text-primary border-primary"} hover:scale-[0.97] text-xs md:text-sm px-2 py-[6px] md:p-0 border-[1px] md:border-none rounded-md md:rounded-none md:underline whitespace-nowrap`}>
                            or upload an image
                        </p>
                    </div>
