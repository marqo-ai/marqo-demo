...
export const TryMarqo = () => {
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row justify-start items-center rounded-lg w-[80%] md:w-[45vw] lg:w-[40vw] 2xl:w-[30vw] px-0 ${
        theme === 'dark' ? 'text-primary bg-slate-700' : 'text-slate-700 bg-slate-100'
      }`}
    >
      <div
        className={`${
          theme === 'dark' ? 'bg-slate-800' : 'bg-slate-700'
        } flex justify-center py-8 lg:pt-12 lg:pb-16 rounded-t-lg rounded-b-none lg:rounded-r-none lg:rounded-l-lg w-full basis-1/2`}
      >
        <MarqoWLink />
      </div>
